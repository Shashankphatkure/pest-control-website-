      ...
      <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Reveal className="flex flex-col border border-[var(--color-ink)]/10 bg-white">
          <div className="aspect-[16/9] w-full">
            <PhotoPlaceholder label="Residential property treatment" icon={Home} className="size-full" />
          </div>
        ...
        >
          <div className="aspect-[16/9] w-full">
            <PhotoPlaceholder label="Commercial kitchen inspection" icon={Building2} className="size-full" variant="dark" />
          </div>
          <div className="flex flex-col gap-3 p-7">
